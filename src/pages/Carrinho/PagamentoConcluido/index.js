          ...
          <ContainerBlocoInfos>
            <ContainerTituloPagamento>
              ...
              <ContainerEscritaTitulo>
                ...
                <TextoPedido>
                  Seu pedido #{ultimaCompra && ultimaCompra.venda.id_venda} foi
                ...
                {ultimaCompra &&
                  ultimaCompra.detalhesVenda.map((item, index) => (
                    <ContainerItemPagamento key={index}>
                      <ContainerImagemPagamento>
                        <ImagemCarrinho
                          src={item.variacaoProduto.imagens_variacao_produto[0]}
                        />
                      </ContainerImagemPagamento>
                      <ContainerInfosItemPagamento>
                        <NomeIitem>
                        ...
                        <CorETamanho style={{ fontSize: 12 }}>
                          ...
                          Medida: {item.variacaoProduto.medida_variacao_produto}{" "}
